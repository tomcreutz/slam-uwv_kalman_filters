...
namespace uwv_kalman_filters
{
   ...
   */
  class SimplePoseUKF : public pose_estimation::UnscentedKalmanFilter<SimplePoseState>
  {
  public:
    /**
  ...
  public:
     ...
     */
    SimplePoseUKF(const Eigen::Vector3d &imu_in_nwu_pos, const Eigen::Matrix3d &imu_in_nwu_pos_cov,
