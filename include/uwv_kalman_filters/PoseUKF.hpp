...
// #include <auv_motion_model/FossenDampingModel.hpp>
...
//                 const PoseUKFConfig &pose_filter_config, const auv_model::Parameters &model_parameters,
...
//         boost::shared_ptr<auv_model::FossenDampingModel> dynamic_model;
