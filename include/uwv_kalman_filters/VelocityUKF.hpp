...
#include <auv_motion_model/MotionModelBase.hpp>
...
namespace uwv_kalman_filters
{
    ...
    MTK_BUILD_MANIFOLD(VelocityState,
                       ((VelocityType, velocity))((ZPosType, z_position)))
    ...
    public:
        ...
        bool setupMotionModel(const auv_model::Parameters &parameters);
    ...
    protected:
        boost::shared_ptr<auv_model::MotionModelBase> motion_model;
        boost::shared_ptr<auv_model::MotionModelBase> prediction_model; // TODO: Is this MotionModelBase the correct class for this ?
